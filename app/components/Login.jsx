...
const Login = ({ login }) => {
  ...
  return (
    ...
    <div className='max-w-[500px] mx-auto my-[10rem] overflow-auto min-h-[300px] border-2 border-black border-opacity-86 shadow-standard p-5 rounded-15  bg-black bg-opacity-90 '>
      <h1>Login</h1>
      <form>
        <div className='my-5'>
